...
preferences
{
	input("cjalas",	"text",		title: "Camera username",	description: "Username for web login")
	input("alas3541",	"password",	title: "Camera password",	description: "Password for web login")
	input("72.91.213.16",		"text",		title: "IP or URL of camera",	description: "Do not include http://")
	input("888",		"text",		title: "Port",			description: "Port")
}
